 ...
 */
final class Version20230723173551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE submission (id INT AUTO_INCREMENT NOT NULL, season_id INT NOT NULL, user_id INT NOT NULL, activity_id INT NOT NULL, faculty_id INT NOT NULL, accepted TINYINT(1) DEFAULT NULL, elevation INT NOT NULL, distance INT NOT NULL, reviewed TINYINT(1) NOT NULL, image VARCHAR(255) NOT NULL, date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', week INT NOT NULL, INDEX IDX_DB055AF34EC001D1 (season_id), INDEX IDX_DB055AF3A76ED395 (user_id), INDEX IDX_DB055AF381C06096 (activity_id), INDEX IDX_DB055AF3680CAB68 (faculty_id), INDEX date_index (date), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
