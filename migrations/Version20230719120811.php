 ...
 */
final class Version20230719120811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE faculty_summary (id INT AUTO_INCREMENT NOT NULL, season_id INT NOT NULL, faculty_id INT NOT NULL, activity_id INT NOT NULL, distance INT NOT NULL, elevation INT NOT NULL, week INT NOT NULL, INDEX IDX_8F3BB0394EC001D1 (season_id), INDEX IDX_8F3BB039680CAB68 (faculty_id), INDEX IDX_8F3BB03981C06096 (activity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE season (id INT AUTO_INCREMENT NOT NULL, charity_id INT NOT NULL, start DATE NOT NULL, end DATE NOT NULL, UNIQUE INDEX UNIQ_F0E45BA9F5C97E37 (charity_id), INDEX date_index (start), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE submission (id INT AUTO_INCREMENT NOT NULL, season_id INT NOT NULL, user_id INT NOT NULL, activity_id INT NOT NULL, accepted TINYINT(1) DEFAULT NULL, elevation INT NOT NULL, distance INT NOT NULL, reviewed TINYINT(1) NOT NULL, image VARCHAR(255) NOT NULL, date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', INDEX IDX_DB055AF34EC001D1 (season_id), INDEX IDX_DB055AF3A76ED395 (user_id), INDEX IDX_DB055AF381C06096 (activity_id), INDEX date_index (date), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_summary (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, season_id INT NOT NULL, activity_id INT NOT NULL, distance INT NOT NULL, elevation INT NOT NULL, week INT NOT NULL, INDEX IDX_96257869A76ED395 (user_id), INDEX IDX_962578694EC001D1 (season_id), INDEX IDX_9625786981C06096 (activity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE faculty_summary ADD CONSTRAINT FK_8F3BB03981C06096 FOREIGN KEY (activity_id) REFERENCES activity (id)');
        ...
        $this->addSql('ALTER TABLE user_summary ADD CONSTRAINT FK_9625786981C06096 FOREIGN KEY (activity_id) REFERENCES activity (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE faculty_summary DROP FOREIGN KEY FK_8F3BB03981C06096');
        ...
        $this->addSql('ALTER TABLE user_summary DROP FOREIGN KEY FK_9625786981C06096');
