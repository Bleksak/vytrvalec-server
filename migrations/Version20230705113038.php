 ...
 */
final class Version20230705113038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season AK_F0E45BA9F5C97E37 FOREIGN KEY (charity_id) REFERENCES charity (id)');
