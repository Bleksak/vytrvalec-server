 ...
 */
final class Version20231117155243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE submission (id INT AUTO_INCREMENT NOT NULL, season_id INT NOT NULL, user_id INT NOT NULL, activity_id INT NOT NULL, accepted TINYINT(1) DEFAULT NULL, elevation BIGINT NOT NULL, distance BIGINT NOT NULL, reviewed TINYINT(1) NOT NULL, image VARCHAR(255) NOT NULL, week INT NOT NULL, date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, INDEX IDX_DB055AF34EC001D1 (season_id), INDEX IDX_DB055AF3A76ED395 (user_id), INDEX IDX_DB055AF381C06096 (activity_id), INDEX week_index (week), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
