...
class UserSummaryRepository extends ServiceEntityRepository
{
    ...
    public function save(UserSummary $entity, bool $flush = false): void
    {
    ...
    public function remove(UserSummary $entity, bool $flush = false): void
    {
...
//    /**
//     * @return UserSummary[] Returns an array of UserSummary objects
//     */
...
//    public function findOneBySomeField($value): ?UserSummary
//    {
//        return $this->createQueryBuilder('u')
//            ->andWhere('u.exampleField = :val')
//            ->setParameter('val', $value)
