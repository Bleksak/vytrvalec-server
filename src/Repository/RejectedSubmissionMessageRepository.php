...
class RejectedSubmissionMessageRepository extends ServiceEntityRepository
{
    ...
    public function findByUser(User $user): array
    {
        $query = $this->getEntityManager()->getConnection()->prepare('
            SELECT * FROM (
                SELECT null as message, s.id as id, s.activity_id as activity, s.week, s.distance, s.elevation, s.accepted, s.reviewed, s.date, s.image, s.updated_at as updatedAt, s.season_id as season
                FROM submission s
                ...
                UNION ALL
                SELECT m.message, s.id as id, s.activity_id as activity, s.week, s.distance, s.elevation, s.accepted, s.reviewed, s.date, s.image, s.updated_at as updatedAt, s.season_id as season
