...
return [
    ...
    'account' => [
        'title' => 'Účet | Měsíční Vytrvalec',
        'email' => 'E-mail',
        'edit' => [
            'mailing' => 'Přeji si dostávat e-maily',
            'password_change' => 'Změna hesla',
            'current_password' => 'Současné heslo',
            'new_password' => 'Nové heslo',
            'new_password_repeat' => 'Nové heslo znovu',
            'anonymize' => 'Souhlasím se zveřejněním celého jména ve výsledcích',
            'submit' => 'Uložit',
        ],
        'anonymize_tooltip' => 'Aplikace umožňuje zveřejnění jmen účastníků, kteří získali bonusové body pro svou fakultu nebo dosáhli mimořádných výsledků Poskytnutí souhlasu je dobrovolné. Pokud souhlas neudělíte, vaše jméno nebude zveřejněno a zobrazí se pouze název fakulty. V takovém případě ponechte příslušné pole prázdné a potvrďte uložením.',
        'danger_zone' => 'Nebezpečná zóna',
        'delete' => [
            'title' => 'Smazat účet',
            'button' => 'Smazat účet',
            'text1' => 'Smazání účtu je nevratné. Tato akce nelze vzít zpět.',
            'text2' => 'Po stisknutí tlačítka odstranit bude váš účet okamžitě zpracován ke smazání a všechna data budou trvale odstraněna.',
            'text3' => 'Jakmile účet smažete, již ho nelze obnovit.',
            'text4' => 'Měsíční Vytrvalec si bude nadále uchovávat Vaše sdílené aktivity za účelem uchování statistik uplynulých ročníků soutěže. Nebudou ovšem nijak spojeny s vaším stávajícím účtem.',
            'submit' => 'Odstranit',
        ],
        'note' => 'Pokud některé údaje nesedí, kontaktujte nás na email vytrvale@ntis.zcu.cz',
    ],
];
